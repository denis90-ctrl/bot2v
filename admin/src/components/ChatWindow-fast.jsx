...
const ChatWindowFast = memo(({ selectedUser, messages, onSendMessage, onEditMessage, onDeleteMessage, onError, loading, sending, setSending, apiService, setMessages, setUsers }) => {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Заголовок чата */}
      <div className="flex items-center space-x-3 px-4 py-3 border-b border-gray-700 bg-gray-800">
...
ChatWindowFast.displayName = 'ChatWindowFast';
export default ChatWindowFast; 