...
const ChatWindowSimple = memo(({ selectedUser, messages, onSendMessage, onEditMessage, onDeleteMessage, onError, loading, sending, setSending, apiService, setMessages, setUsers }) => {
...
ChatWindowSimple.displayName = 'ChatWindowSimple';
